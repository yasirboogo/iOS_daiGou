...
- (void)setSubviewsFrame {
    ...
    if (self.message.length > 0) {
        messageLabelSize = [self.message hd_sizeWithSystemFont:self.messageLabel.font constrainedToSize:CGSizeMake(containerViewW-20*2, MAXFLOAT)];
    }
    
    CGFloat messageLabelH = messageLabelSize.height;
    CGFloat messageLabelW = containerViewW-20*2;
    CGFloat messageLabelX = 0;
    CGFloat messageLabelY = CGRectGetMaxY(self.titleLabel.frame) + margin;
    self.messageLabel.frame = CGRectMake(messageLabelX+20, messageLabelY, messageLabelW, messageLabelH);
