...
@implementation YNCodeImageOperation
+(UIImage*)getCodeImageWithContent:(NSString*)content width:(CGFloat)width{
    ...
    // 5.显示二维码
    return [YNCodeImageOperation createNonInterpolatedUIImageFormCIImage:outputImage withSize:width];
}
